...
*/ -}}
{{- define "eric-oss-4gpmevent-filetrans-proc.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-4gpmevent-filetrans-proc.mergeAnnotations" -}}
  {{- include "eric-oss-4gpmevent-filetrans-proc.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-4gpmevent-filetrans-proc.mergeLabels" -}}
  {{- include "eric-oss-4gpmevent-filetrans-proc.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
