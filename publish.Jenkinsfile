...
def bob = new BobCommand()
    ...
    .envVars([
        ...
        MARKETPLACE_4GPM_TOKEN:'${MARKETPLACE_4GPM_TOKEN}',
...
pipeline {
    ...
    stages {
        ...
        stage('Upload Marketplace Documentation') {
            steps {
                withCredentials([string(credentialsId: 'MARKETPLACE_4GPM_TOKEN',variable: 'MARKETPLACE_4GPM_TOKEN')]) {
...
def modifyBuildDescription() {
    ...
    def CHART_NAME = "eric-oss-4gpmevent-filetrans-proc"
    def DOCKER_IMAGE_NAME = "eric-oss-4gpmevent-filetrans-proc"
...
def bumpVersionPrefixPatch() {
    ...
    env.newPatchVersionPrefix = env.versionPrefix.trim()
